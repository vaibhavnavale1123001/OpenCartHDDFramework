...
public class ExtentReportManager implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			// To attach snap in Extent Report
			Object crnClassObj = result.getInstance();
			String imgPath = ((BaseClass) crnClassObj).captureScreen(result.getName());
			// String imgPath = new BaseClass().captureScreen(result.getName());
			test.addScreenCaptureFromPath(imgPath);

			// To attach snap in TestNG Report
			Reporter.log("<a href='" + imgPath + "'> <img src='" + imgPath + "' height='100' width='100'/> </a>");
